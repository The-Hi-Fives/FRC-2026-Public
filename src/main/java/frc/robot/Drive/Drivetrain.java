...
public class Drivetrain extends TimedRobot {
  ...
  private final TalonFX leftLeader = new TalonFX(0, kCANBus);
  private final TalonFX leftFollower = new TalonFX(1, kCANBus);
  private final TalonFX rightLeader = new TalonFX(2, kCANBus);
  private final TalonFX rightFollower = new TalonFX(3, kCANBus);
  ...
  public void teleopPeriodic() {
    /* Get forward and rotational throttle from driver */
    /* invert the driver Y because forward Y is negative */
